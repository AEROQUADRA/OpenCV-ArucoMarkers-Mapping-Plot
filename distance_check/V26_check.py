...
def find_aruco_like_markers(image):
    ...
    aruco_params.adaptiveThreshConstant = 1  # Try lowering this value
    ...
    aruco_params.minDistanceToBorder = 1  # Try lowering this value
    aruco_params.minOtsuStdDev = 1.0  # Try lowering this value
